package com.selvamano.interview.stringproblem;
...
public class RemoveOccurences {
	public static void main(String args[]) {
		...
		RemoveOccurences removeOcc = new RemoveOccurences();

		// resultString1 is the string that holds the manipulated String
		// achieved through iteration.
		String resultString1 = removeOcc.iterationMethod(inputString, inputChar);
		...
		String resultString12 = removeOcc.builtInFunction(inputString, inputChar);
